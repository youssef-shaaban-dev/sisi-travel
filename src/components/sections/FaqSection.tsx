...
export default function FaqSection() {
  ...
  const faqs: FaqItem[] = [
    ...
    },
    {
      ...
      answer:
        'يمكنكم التواصل المباشر مع فريق المبيعات والخدمة عبر الواتساب أو الاتصال الهاتفي بأرقام الشركة الرسمية، أو زيارة مقر المركز الرئيسي بشرع السودان بالمهندسين أو أحد فروعنا بالمحافظات.',
    },
  ];
