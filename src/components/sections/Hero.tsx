...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-[#281015]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#281015] via-[#281015]/60 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#281015]/80 via-transparent to-[#281015]/80" />
      </div>

      {/* Content */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        {/* Heritage Trust Badge */}
        <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#531F23]/80 border border-[#C5A059]/40 backdrop-blur-md mb-6 shadow-xl animate-fadeIn">
          <Award className="w-4 h-4 text-[#C5A059]" />
          <span className="text-xs sm:text-sm font-bold text-[#E0D9C9] tracking-wide">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight text-white mb-6 font-sans">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E0D9C9] via-[#C5A059] to-[#E0D9C9]">
            تبدأ بثقة واطمئنان
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
          <a
            href="#umrah"
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#531F23] hover:bg-[#6E2B30] text-white font-extrabold text-base shadow-xl hover:shadow-2xl transition-all border border-[#C5A059]/50 group"
          >
            <Compass className="w-5 h-5 text-[#C5A059] group-hover:rotate-45 transition-transform" />
        ...
        <div className="mt-14 pt-10 border-t border-white/10 grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-xs sm:text-sm text-gray-300">
          <div className="flex flex-col items-center gap-1.5">
            <span className="font-extrabold text-xl text-[#C5A059]">40+ سنة</span>
            <span className="text-gray-300">خبرة في الحج والعمرة</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <span className="font-extrabold text-xl text-[#C5A059]">فنادق VIP</span>
            <span className="text-gray-300">مطلة وقريبة من الحرمين</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <span className="font-extrabold text-xl text-[#C5A059]">طيران مباشر</span>
            <span className="text-gray-300">مصر للطيران والسعودية</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <span className="font-extrabold text-xl text-[#C5A059]">متابعة 24/7</span>
