      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative h-[420px] sm:h-[480px] rounded-2xl overflow-hidden shadow-2xl border-4 border-brand-sand">
              <Image
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-6 right-6 left-6 bg-brand-burgundy-dark/90 backdrop-blur-md border border-brand-gold/40 p-5 rounded-xl text-white shadow-xl">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-brand-burgundy rounded-lg text-brand-gold">
                    <ShieldCheck className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-bold text-base text-white">سيسي ترافل (Sisi Travel)</h4>
                    <p className="text-xs text-brand-sand mt-0.5">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-4">
              <h3 className="text-2xl sm:text-3xl font-extrabold text-brand-burgundy-dark leading-snug">
                خبرة متراكمة نضعها في خدمتكم لتكون رحلتكم الإيمانية ذكرى لا تُنسى
              </h3>
              <p className="text-base text-gray-700 leading-relaxed">
                في <strong className="text-brand-burgundy">سيسي ترافل</strong>، نؤمن بأن أداء فريضة الحج والعمرة هي من أغلى أمنيات كل مسلم. ولذلك، نكرس كافة إمكانياتنا وخبرتنا العريقة لتصميم برامج تجمع بين الروحانية العالية والراحة التامة.
              </p>
              <p className="text-base text-gray-700 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {values.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-brand-sand-light border border-brand-sand hover:border-brand-burgundy/40 transition-all duration-300 group"
                  >
                    <div className="flex items-start gap-3">
                      <div className="p-2 rounded-lg bg-brand-burgundy/10 text-brand-burgundy group-hover:bg-brand-burgundy group-hover:text-white transition-colors">
                        <IconComp className="w-5 h-5" />
                      </div>
                      <div>
                        <h4 className="font-bold text-sm text-brand-burgundy-dark mb-1">{item.title}</h4>
